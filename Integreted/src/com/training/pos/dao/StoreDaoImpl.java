...
public class StoreDaoImpl implements StoreDao{
	...
	@Override
	public List<StoreBean> getAllStoresuser(String userId) throws PosException {
		try {
			Session session = sf.openSession();
			...
			Query query = session.createQuery("from StoreBean where pincode= :pincode");
			query.setParameter("pincode", pincode);
			List<StoreBean> stores = query.list();
			return stores;			
		}
		catch (Exception e) {
			throw new PosException(e.getMessage());
